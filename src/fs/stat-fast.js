...
function init() {
  ...
  let useFastPath
  let twoArgsInternalModuleStat = (
    gte(safeProcess.versions.node, "22.10.0") && lt(safeProcess.versions.node, "22.18.0")
  ) || (
    gte(safeProcess.versions.node, "23.0.0") && lt(safeProcess.versions.node, "24.0.0")
  )
